...
public final class AttriaxInAppBrowserActivity extends ComponentActivity {
    public static final String EXTRA_URL = "attriax.browser_url";

    private static final String TAG = "AttriaxInAppBrowser";
    ...
    private static final class AttriaxBrowserWebViewClient extends WebViewClient {
        private final WeakReference<AttriaxInAppBrowserActivity> activityReference;

        AttriaxBrowserWebViewClient(@NonNull AttriaxInAppBrowserActivity activity) {
        ...
        public void onReceivedSslError(
            ...
            final AttriaxInAppBrowserActivity activity = activityReference.get();
