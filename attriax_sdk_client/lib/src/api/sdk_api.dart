...
class SdkApi {
  ...
  Future<Response<SdkCreateDynamicLinkResponseEnvelopeDto>> sdkControllerCreateDynamicLinkV1({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(sdkCreateDynamicLinkDto, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SdkCreateDynamicLinkResponseEnvelopeDto),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SdkLatestUnityReleaseResponseEnvelopeDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SdkLatestUnityReleaseResponseEnvelopeDto>> sdkControllerGetLatestUnityReleaseV1({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/sdk/v1/releases/unity/latest';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SdkLatestUnityReleaseResponseEnvelopeDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SdkLatestUnityReleaseResponseEnvelopeDto),
      ) as SdkLatestUnityReleaseResponseEnvelopeDto;
    ...
    return Response<SdkLatestUnityReleaseResponseEnvelopeDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SdkAcknowledgeResponseEnvelopeDto>> sdkControllerIdentifyV1({ 
    required SdkIdentifyDto sdkIdentifyDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/sdk/v1/identify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SdkIdentifyDto);
      _bodyData = _serializers.serialize(sdkIdentifyDto, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SdkUnityReleaseListResponseEnvelopeDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SdkUnityReleaseListResponseEnvelopeDto>> sdkControllerListUnityReleasesV1({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/sdk/v1/releases/unity';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SdkUnityReleaseListResponseEnvelopeDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SdkUnityReleaseListResponseEnvelopeDto),
      ) as SdkUnityReleaseListResponseEnvelopeDto;
    ...
    return Response<SdkUnityReleaseListResponseEnvelopeDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SdkV1DeepLinkResolveResponseEnvelopeDto>> sdkControllerResolveDeepLinkV1({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(sdkV1DeepLinkResolveDto, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SdkV1DeepLinkResolveResponseEnvelopeDto),
  ...
  /// Returns a [Future] containing a [Response] with a [SdkAcknowledgeResponseEnvelopeDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SdkAcknowledgeResponseEnvelopeDto>> sdkControllerTrackEventV1({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SdkUnityEditorValidateResponseEnvelopeDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SdkUnityEditorValidateResponseEnvelopeDto>> sdkControllerValidateUnityEditorV1({ 
    required SdkV1UnityEditorValidateDto sdkV1UnityEditorValidateDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/sdk/v1/unity-editor/validate';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SdkV1UnityEditorValidateDto);
      _bodyData = _serializers.serialize(sdkV1UnityEditorValidateDto, specifiedType: _type);
    ...
    SdkUnityEditorValidateResponseEnvelopeDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SdkUnityEditorValidateResponseEnvelopeDto),
      ) as SdkUnityEditorValidateResponseEnvelopeDto;
    ...
    return Response<SdkUnityEditorValidateResponseEnvelopeDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
