...
/// * [timestamp] 
@BuiltValue()
abstract class SdkV1OpenResponseEnvelopeDto implements Built<SdkV1OpenResponseEnvelopeDto, SdkV1OpenResponseEnvelopeDtoBuilder> {
  ...
  factory SdkV1OpenResponseEnvelopeDto([void updates(SdkV1OpenResponseEnvelopeDtoBuilder b)]) = _$SdkV1OpenResponseEnvelopeDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkV1OpenResponseEnvelopeDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkV1OpenResponseEnvelopeDto> get serializer => _$SdkV1OpenResponseEnvelopeDtoSerializer();
}

class _$SdkV1OpenResponseEnvelopeDtoSerializer implements PrimitiveSerializer<SdkV1OpenResponseEnvelopeDto> {
  @override
  final Iterable<Type> types = const [SdkV1OpenResponseEnvelopeDto, _$SdkV1OpenResponseEnvelopeDto];
