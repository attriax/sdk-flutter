...
/// * [userId] 
@BuiltValue()
abstract class SdkV1OpenResponseDto implements Built<SdkV1OpenResponseDto, SdkV1OpenResponseDtoBuilder> {
  ...
  factory SdkV1OpenResponseDto([void updates(SdkV1OpenResponseDtoBuilder b)]) = _$SdkV1OpenResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkV1OpenResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkV1OpenResponseDto> get serializer => _$SdkV1OpenResponseDtoSerializer();
}

class _$SdkV1OpenResponseDtoSerializer implements PrimitiveSerializer<SdkV1OpenResponseDto> {
  @override
  final Iterable<Type> types = const [SdkV1OpenResponseDto, _$SdkV1OpenResponseDto];
