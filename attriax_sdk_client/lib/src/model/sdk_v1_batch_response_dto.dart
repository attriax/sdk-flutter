...
/// * [requestVersion] 
@BuiltValue()
abstract class SdkV1BatchResponseDto implements Built<SdkV1BatchResponseDto, SdkV1BatchResponseDtoBuilder> {
  ...
  factory SdkV1BatchResponseDto([void updates(SdkV1BatchResponseDtoBuilder b)]) = _$SdkV1BatchResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkV1BatchResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkV1BatchResponseDto> get serializer => _$SdkV1BatchResponseDtoSerializer();
}

class _$SdkV1BatchResponseDtoSerializer implements PrimitiveSerializer<SdkV1BatchResponseDto> {
  @override
  final Iterable<Type> types = const [SdkV1BatchResponseDto, _$SdkV1BatchResponseDto];
