...
/// * [version] 
@BuiltValue()
abstract class AppVersionContextDto implements Built<AppVersionContextDto, AppVersionContextDtoBuilder> {
  ...
  factory AppVersionContextDto([void updates(AppVersionContextDtoBuilder b)]) = _$AppVersionContextDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AppVersionContextDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AppVersionContextDto> get serializer => _$AppVersionContextDtoSerializer();
}

class _$AppVersionContextDtoSerializer implements PrimitiveSerializer<AppVersionContextDto> {
  @override
  final Iterable<Type> types = const [AppVersionContextDto, _$AppVersionContextDto];
