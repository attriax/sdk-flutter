...
import 'package:attriax_sdk_client/src/model/sdk_session_lifecycle_kind.dart';
...
@BuiltValue()
abstract class SdkSessionDto implements Built<SdkSessionDto, SdkSessionDtoBuilder> {
  ...
  factory SdkSessionDto([void updates(SdkSessionDtoBuilder b)]) = _$SdkSessionDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkSessionDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkSessionDto> get serializer => _$SdkSessionDtoSerializer();
}
