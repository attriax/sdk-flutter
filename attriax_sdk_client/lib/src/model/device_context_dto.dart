...
/// * [timezone] 
@BuiltValue()
abstract class DeviceContextDto implements Built<DeviceContextDto, DeviceContextDtoBuilder> {
  ...
  factory DeviceContextDto([void updates(DeviceContextDtoBuilder b)]) = _$DeviceContextDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeviceContextDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeviceContextDto> get serializer => _$DeviceContextDtoSerializer();
}

class _$DeviceContextDtoSerializer implements PrimitiveSerializer<DeviceContextDto> {
  @override
