...
/// * [requestVersion] 
@BuiltValue()
abstract class SdkCreateDynamicLinkResponseDto implements Built<SdkCreateDynamicLinkResponseDto, SdkCreateDynamicLinkResponseDtoBuilder> {
  ...
  factory SdkCreateDynamicLinkResponseDto([void updates(SdkCreateDynamicLinkResponseDtoBuilder b)]) = _$SdkCreateDynamicLinkResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkCreateDynamicLinkResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkCreateDynamicLinkResponseDto> get serializer => _$SdkCreateDynamicLinkResponseDtoSerializer();
}

class _$SdkCreateDynamicLinkResponseDtoSerializer implements PrimitiveSerializer<SdkCreateDynamicLinkResponseDto> {
  @override
  final Iterable<Type> types = const [SdkCreateDynamicLinkResponseDto, _$SdkCreateDynamicLinkResponseDto];
