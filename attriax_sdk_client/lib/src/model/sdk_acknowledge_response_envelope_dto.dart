...
/// * [timestamp] 
@BuiltValue()
abstract class SdkAcknowledgeResponseEnvelopeDto implements Built<SdkAcknowledgeResponseEnvelopeDto, SdkAcknowledgeResponseEnvelopeDtoBuilder> {
  ...
  factory SdkAcknowledgeResponseEnvelopeDto([void updates(SdkAcknowledgeResponseEnvelopeDtoBuilder b)]) = _$SdkAcknowledgeResponseEnvelopeDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkAcknowledgeResponseEnvelopeDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkAcknowledgeResponseEnvelopeDto> get serializer => _$SdkAcknowledgeResponseEnvelopeDtoSerializer();
}

class _$SdkAcknowledgeResponseEnvelopeDtoSerializer implements PrimitiveSerializer<SdkAcknowledgeResponseEnvelopeDto> {
  @override
  final Iterable<Type> types = const [SdkAcknowledgeResponseEnvelopeDto, _$SdkAcknowledgeResponseEnvelopeDto];
