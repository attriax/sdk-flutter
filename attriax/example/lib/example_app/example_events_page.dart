    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        return ExamplePageScaffold(
          title: 'Events',
          subtitle:
              'Use the standardized helpers when they fit, and fall back to recordEvent() for app-specific analytics.',
          child: Column(
            ...
            children: <Widget>[
              ExampleSectionCard(
                title: 'Custom events',
                subtitle:
                    'These buttons call attriax.recordEvent(...) with payloads your app would normally send from real UX moments.',
                child: Wrap(
                  spacing: 12,
                  runSpacing: 12,
                  children: <Widget>[
