...
**attributionType** | [**AttributionType**](AttributionType.md) | Attribution source classification for the startup referrer payload. | 
...
**deepLinkData** | **BuiltMap&lt;String, String&gt;** | Resolved deep-link payload data associated with the startup referrer. | [optional] 
**deepLinkUri** | **String** | Full tracked short-link URI associated with the resolved deep link. | [optional] 
**deepLinkUrl** | **String** | Deprecated alias for deepLinkUri kept for HTTP compatibility. | [optional] 
...
**rawPlatformInstallReferrer** | **String** | Raw platform startup referrer string cached by the SDK, when available. | [optional] 
