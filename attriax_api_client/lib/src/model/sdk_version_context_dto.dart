...
/// * [packageVersion]
@BuiltValue()
abstract class SdkVersionContextDto
    implements Built<SdkVersionContextDto, SdkVersionContextDtoBuilder> {
  ...
  factory SdkVersionContextDto([void updates(SdkVersionContextDtoBuilder b)]) =
      _$SdkVersionContextDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkVersionContextDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkVersionContextDto> get serializer =>
      _$SdkVersionContextDtoSerializer();
}

class _$SdkVersionContextDtoSerializer
    implements PrimitiveSerializer<SdkVersionContextDto> {
  @override
