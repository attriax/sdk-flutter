...
part of 'sdk_v1_skan_coarse_window_event_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SdkV1SkanCoarseWindowEventDto _$SdkV1SkanCoarseWindowEventDtoFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('SdkV1SkanCoarseWindowEventDto', json, ($checkedConvert) {
  $checkKeys(json, requiredKeys: const ['conditions', 'eventName', 'id']);
  final val = SdkV1SkanCoarseWindowEventDto(
    ...
    conditions: $checkedConvert(
      'conditions',
      (v) => (v as List<dynamic>)
          .map((e) => SdkV1SkanConditionDto.fromJson(e as Map<String, dynamic>))
          .toList(),
    ),
...
Map<String, dynamic> _$SdkV1SkanCoarseWindowEventDtoToJson(
  SdkV1SkanCoarseWindowEventDto instance,
) => <String, dynamic>{
