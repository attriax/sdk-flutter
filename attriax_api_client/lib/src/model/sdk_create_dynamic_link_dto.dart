...
/// * [utmTerm]
@BuiltValue()
abstract class SdkCreateDynamicLinkDto
    implements Built<SdkCreateDynamicLinkDto, SdkCreateDynamicLinkDtoBuilder> {
  ...
  factory SdkCreateDynamicLinkDto([
    void updates(SdkCreateDynamicLinkDtoBuilder b),
  ]) = _$SdkCreateDynamicLinkDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkCreateDynamicLinkDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkCreateDynamicLinkDto> get serializer =>
      _$SdkCreateDynamicLinkDtoSerializer();
}

class _$SdkCreateDynamicLinkDtoSerializer
    implements PrimitiveSerializer<SdkCreateDynamicLinkDto> {
  @override
