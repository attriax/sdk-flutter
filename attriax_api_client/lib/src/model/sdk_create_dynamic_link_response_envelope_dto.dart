...
/// * [timestamp]
@BuiltValue()
abstract class SdkCreateDynamicLinkResponseEnvelopeDto
    implements
        Built<
          SdkCreateDynamicLinkResponseEnvelopeDto,
  ...
  factory SdkCreateDynamicLinkResponseEnvelopeDto([
    void updates(SdkCreateDynamicLinkResponseEnvelopeDtoBuilder b),
  ]) = _$SdkCreateDynamicLinkResponseEnvelopeDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkCreateDynamicLinkResponseEnvelopeDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkCreateDynamicLinkResponseEnvelopeDto> get serializer =>
      _$SdkCreateDynamicLinkResponseEnvelopeDtoSerializer();
}

class _$SdkCreateDynamicLinkResponseEnvelopeDtoSerializer
    implements PrimitiveSerializer<SdkCreateDynamicLinkResponseEnvelopeDto> {
  @override
