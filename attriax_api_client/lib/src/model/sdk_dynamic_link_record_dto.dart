...
/// * [utmTerm]
@BuiltValue()
abstract class SdkDynamicLinkRecordDto
    implements Built<SdkDynamicLinkRecordDto, SdkDynamicLinkRecordDtoBuilder> {
  ...
  factory SdkDynamicLinkRecordDto([
    void updates(SdkDynamicLinkRecordDtoBuilder b),
  ]) = _$SdkDynamicLinkRecordDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkDynamicLinkRecordDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkDynamicLinkRecordDto> get serializer =>
      _$SdkDynamicLinkRecordDtoSerializer();
}

class _$SdkDynamicLinkRecordDtoSerializer
    implements PrimitiveSerializer<SdkDynamicLinkRecordDto> {
  @override
