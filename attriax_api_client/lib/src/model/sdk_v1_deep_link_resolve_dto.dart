...
/// * [source_]
@BuiltValue()
abstract class SdkV1DeepLinkResolveDto
    implements Built<SdkV1DeepLinkResolveDto, SdkV1DeepLinkResolveDtoBuilder> {
  ...
  factory SdkV1DeepLinkResolveDto([
    void updates(SdkV1DeepLinkResolveDtoBuilder b),
  ]) = _$SdkV1DeepLinkResolveDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkV1DeepLinkResolveDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkV1DeepLinkResolveDto> get serializer =>
      _$SdkV1DeepLinkResolveDtoSerializer();
}

class _$SdkV1DeepLinkResolveDtoSerializer
    implements PrimitiveSerializer<SdkV1DeepLinkResolveDto> {
  @override
