...
/// * [timestamp]
@BuiltValue()
abstract class SdkV1BatchResponseEnvelopeDto
    implements
        Built<
          SdkV1BatchResponseEnvelopeDto,
  ...
  factory SdkV1BatchResponseEnvelopeDto([
    void updates(SdkV1BatchResponseEnvelopeDtoBuilder b),
  ]) = _$SdkV1BatchResponseEnvelopeDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkV1BatchResponseEnvelopeDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkV1BatchResponseEnvelopeDto> get serializer =>
      _$SdkV1BatchResponseEnvelopeDtoSerializer();
}

class _$SdkV1BatchResponseEnvelopeDtoSerializer
    implements PrimitiveSerializer<SdkV1BatchResponseEnvelopeDto> {
  @override
