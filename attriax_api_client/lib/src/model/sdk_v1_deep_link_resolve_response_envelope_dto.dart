...
/// * [timestamp]
@BuiltValue()
abstract class SdkV1DeepLinkResolveResponseEnvelopeDto
    implements
        Built<
          SdkV1DeepLinkResolveResponseEnvelopeDto,
  ...
  factory SdkV1DeepLinkResolveResponseEnvelopeDto([
    void updates(SdkV1DeepLinkResolveResponseEnvelopeDtoBuilder b),
  ]) = _$SdkV1DeepLinkResolveResponseEnvelopeDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SdkV1DeepLinkResolveResponseEnvelopeDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SdkV1DeepLinkResolveResponseEnvelopeDto> get serializer =>
      _$SdkV1DeepLinkResolveResponseEnvelopeDtoSerializer();
}

class _$SdkV1DeepLinkResolveResponseEnvelopeDtoSerializer
    implements PrimitiveSerializer<SdkV1DeepLinkResolveResponseEnvelopeDto> {
  @override
