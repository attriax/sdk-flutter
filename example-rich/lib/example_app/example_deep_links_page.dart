          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ExampleSectionCard(
                ...
                subtitle:
                    'Use attriax.deepLinks.createDynamicLink() for a real tracked link. The fallback URL still helps validate host-side app-link routing.',
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    TextField(
              ...
              ExampleSectionCard(
                ...
                subtitle:
                    'Useful on desktop, web, or when you want to test deepLinks.recordDeepLink(...) directly without leaving the app.',
                child: Column(
                  children: <Widget>[
                    TextField(
