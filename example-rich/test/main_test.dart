...
import 'package:attriax_flutter_rich_example/example_platform_bridge.dart';
import 'package:attriax_flutter_rich_example/example_push_tokens.dart';
import 'package:attriax_flutter_rich_example/main.dart';
...
class FakeAttriax extends Fake implements Attriax {
  ...
  @override
  late final AttriaxTracking tracking = _FakeAttriaxTracking(this);
...
class _FakeAttriaxTracking extends Fake implements AttriaxTracking {
  _FakeAttriaxTracking(this._sdk);

  final FakeAttriax _sdk;

  @override
  bool get enabled => _sdk._eventsEnabled;

  @override
  set enabled(bool value) {
    _sdk._eventsEnabled = value;
  }
  ...
  Future<void> setUserProperties(Map<String, Object?> properties) =>
      _sdk.setUserProperties(properties);

  @override
  Future<void> clearUserProperties({List<String>? propertyNames}) =>
      _sdk.clearUserProperties(propertyNames: propertyNames);
}
